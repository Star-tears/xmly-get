<template>
    <div class="flex flex-col mx-4 lg:mx-12 my-1">

        <div class="flex flex-col gap-2 x-8">
            ...
            <div class="flex items-start rounded-xl bg-white p-4 shadow-lg">
                ...
                <div class="ml-4">
                    <h2 class="font-semibold">{{ "书籍id: " + id }}</h2>
                    <p class="mt-2 text-sm text-gray-500">...</p>
                </div>
            </div>
            <div class="flex items-start rounded-xl bg-white p-4 shadow-lg">
                ...
                <div class="ml-4">
                    <h2 class="font-semibold">{{ "发行日期: " + date }}</h2>
                    <p class="mt-2 text-sm text-gray-500">{{ "订阅数: " + subscribe }}</p>
                </div>
            </div>
            <div class="flex items-start rounded-xl bg-white p-4 shadow-lg">
                ...
                <div class="ml-4">
                    <h2 class="font-semibold"><a :href="src">点击聆听</a></h2>
                    <p class="mt-2 text-sm text-gray-500">音频链接</p>
                </div>
            </div>
        </div>
    </div>
...
const audioitem: any = prop.audioitem;
// console.log(audioitem);
const title = ref(audioitem.name);
const id = ref(audioitem.id);
const date = ref(audioitem.date);
const subscribe = ref(audioitem.subscribe);
const src = ref(audioitem.src);
